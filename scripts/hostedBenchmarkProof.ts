...
export function buildHostedBenchmarkProofArtifact(
  ...
  return {
    ...
    summary: {
      ...
      hostedBenchmarkBrokerProofRequirementCount: report.proof.brokerProofRequirements.length,
      hostedBenchmarkBrokerRequiresBackendTrace: report.proof.brokerProofRequirements.includes("backend_trace"),
      hostedBenchmarkBrokerRequiresMemoryGrounding: report.proof.brokerProofRequirements.includes("memory_grounding"),
