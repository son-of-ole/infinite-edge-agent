...
export function summarizeReleaseGateArtifact(parsed: ReleaseGateArtifactInput): ReleaseGateArtifactSummary {
  ...
  if (parsed.summary) {
    ...
    const v12ProductionArchiveFields = [
      ...
      "v12ProductionFallbackBackendId",
      ...
      "v12ProductionPublicModelOptionCount",
      "v12ProductionPublicDeployOptionCount",
      "v12ProductionPublicKernelLabOptionCount",
      "v12ProductionProofSchemaVersion",
      "v12ProductionProofSourceGitSha",
      "v12ProductionProofSourceCommitEvidencePassed",
      ...
      "v12ProductionHostedBenchmarkModelId",
      "v12ProductionHostedBenchmarkDeployUrl",
      "v12ProductionExpectedDeployUrl",
      "v12ProductionDeployUrlBound",
      ...
      "v12ProductionConcreteMemoryGroundingPassed",
      "v12ProductionMemoryGroundingRunCount",
      "v12ProductionMemoryGroundingCaseId",
      "v12ProductionMemorySeededCorpusCount",
      "v12ProductionMemoryRetrievedCount",
      "v12ProductionMemoryIncludedCount",
      "v12ProductionMemoryExpectedMemoryIdCount",
      "v12ProductionMemoryExpectedHitMeanRank",
      "v12ProductionMemoryExpectedHitMinTopScoreMargin",
      "v12ProductionExpectedExactPassed",
      "v12ProductionSpeedFloorPassed",
      "v12ProductionMeanTokensPerSecond",
      "v12ProductionTelemetryRequested",
      "v12ProductionTelemetryConfigured",
      "v12ProductionTelemetrySubmitted",
      "v12ProductionTelemetryStatus",
      "v12ProductionGpuLabelEvidencePassed",
      "v12ProductionGpuVendor",
      "v12ProductionGpuArchitecture",
      "v12ProductionGpuDevice",
      "v12ProductionGpuDescription",
      "v12ProductionWebGlRenderer",
      ...
      "v12ProductionBrokerProofRequirementCount",
      "v12ProductionBrokerRequiresBackendTrace",
      "v12ProductionBrokerRequiresMemoryGrounding",
    ...
    const hostedBenchmarkProofFields = [
      ...
      "hostedBenchmarkModelId",
      "hostedBenchmarkDeployUrl",
      "hostedBenchmarkExpectedDeployUrl",
      "hostedBenchmarkDeployUrlBound",
      "hostedBenchmarkDeployBackendId",
      "hostedBenchmarkCompiledBackendReadyPassed",
      "hostedBenchmarkProductionDeployReadyPassed",
      "hostedBenchmarkMemoryGroundingPassed",
      "hostedBenchmarkConcreteMemoryGroundingPassed",
      "hostedBenchmarkMemoryGroundingRunCount",
      "hostedBenchmarkMemoryGroundingCaseId",
      "hostedBenchmarkMemorySeededCorpusCount",
      "hostedBenchmarkMemoryRetrievedCount",
      "hostedBenchmarkMemoryIncludedCount",
      "hostedBenchmarkMemoryExpectedMemoryIdCount",
      "hostedBenchmarkMemoryExpectedHitMeanRank",
      "hostedBenchmarkMemoryExpectedHitMinTopScoreMargin",
      "hostedBenchmarkExpectedExactPassed",
      "hostedBenchmarkProductionSpeedFloorPassed",
      "hostedBenchmarkMeanTokensPerSecond",
      "hostedBenchmarkTelemetryRequested",
      "hostedBenchmarkTelemetryConfigured",
      "hostedBenchmarkTelemetrySubmitted",
      "hostedBenchmarkTelemetryStatus",
      "hostedBenchmarkGpuLabelEvidencePassed",
      "hostedBenchmarkGpuVendor",
      "hostedBenchmarkGpuArchitecture",
      "hostedBenchmarkGpuDevice",
      "hostedBenchmarkGpuDescription",
      "hostedBenchmarkWebGlRenderer",
      "hostedBenchmarkDirectModelFactualProofUsed",
      ...
      "hostedBenchmarkBrokerProofRequirementCount",
      "hostedBenchmarkBrokerRequiresBackendTrace",
      "hostedBenchmarkBrokerRequiresMemoryGrounding",
    ...
    const v12ReadinessSuiteFields = [
      "v12SuitePassed",
      "v12SuiteBlockerCount",
      "v12SuiteArtifactCount",
      "v12SuiteChildArtifactCount",
      "v12SuiteDeployBackendId",
      "v12SuiteKernelLabBackendId",
      "v12SuiteFallbackBackendId",
      "v12SuiteBackendRoleBoundaryPassed",
      "v12SuiteRequirementCount",
      "v12SuitePassedRequirementCount",
      "v12SuiteHostedProfilePassed",
    ...
    const v12ReadinessFields = [
      ...
      "v12FallbackBackendId",
      "v12BackendRoleBoundaryPassed",
      "v12ModelRegistryAligned",
      "v12ModelRegistryModelCount",
      "v12PublicModelOptionCount",
      "v12PublicDeployOptionCount",
      "v12PublicKernelLabOptionCount",
      "v12RequirementCount",
      "v12PassedRequirementCount",
      "v12HostedProfilePassed",
      "v12HostedProfileDeployUrl",
      "v12HostedProfileBenchmarkDeployUrlBound",
    ...
    const sharedRuntimeFields = [
      ...
      "sharedRuntimeFallbackBackendId",
      "sharedRuntimeBackendRoleBoundaryPassed",
      "sharedRuntimeMemoryProviderCount",
      "sharedRuntimeModelRegistryAligned",
      "sharedRuntimeModelRegistryModelCount",
      "sharedRuntimePublicModelOptionCount",
      "sharedRuntimePublicDeployOptionCount",
      "sharedRuntimePublicKernelLabOptionCount",
    ...
    const backendReadinessFields = [
      ...
      "backendReadinessFallbackBackendCount",
      "backendReadinessFallbackBackendId",
      "backendReadinessFallbackDeployReadyCount",
      "backendReadinessRoleBoundaryPassed",
      "backendReadinessModelRegistryAligned",
      "backendReadinessModelRegistryModelCount",
      "backendReadinessPublicModelOptionCount",
      "backendReadinessPublicDeployOptionCount",
      "backendReadinessPublicKernelLabOptionCount",
    ...
    const hostedProfileFields = [
      ...
      "hostedProfileDeployUrl",
      "hostedProfileBenchmarkDeployUrlBound",
